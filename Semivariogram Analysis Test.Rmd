...
At a kingdom, there is an increase of fossil and other organic fuels combustion to accomodate city's activity. The king is concerned about the increase of air pollution that might happen. The king consulted with scientists and they warned the king about the increase of PM~2.5~ (particulate matter 2.5) in the air.
...
# Fitting with ordinary Kriging method
kriging <- krige(konsentrasi_pm2.5~1, dataSpatial, the.grid, model=fit)

# Plot contour map with Kriging fit result
